...
1. Deploy the Operator and associated resources:
   ...
   ```shell
   git clone https://github.com/nginxinc/nginx-ingress-helm-operator/ --branch v3.2.0
...
`kubectl apply -f https://raw.githubusercontent.com/nginxinc/nginx-ingress-helm-operator/v3.2.0/resources/scc.yaml`

Alternatively, to create an SCC for NIC daemonsets, please run this command:

`kubectl apply -f https://raw.githubusercontent.com/nginxinc/nginx-ingress-helm-operator/v3.2.0/resources/scc-daemonset.yaml`
