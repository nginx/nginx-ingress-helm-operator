...
The latest stable release is [3.5.2](https://github.com/nginx/nginx-ingress-helm-operator/releases/tag/v3.5.2). For production use, we recommend that you choose the latest stable release.
