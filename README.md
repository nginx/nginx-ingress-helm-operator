...
The latest stable release is [3.6.3](https://github.com/nginx/nginx-ingress-helm-operator/releases/tag/v3.6.3). For production use, we recommend that you choose the latest stable release.
